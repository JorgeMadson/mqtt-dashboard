  ...
  <header class="bg-gray-50">
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
      <div class="flex items-center justify-end gap-4">
        <div class="flex items-center gap-4">
          <div class="relative">
            ...
            <input class="h-10 w-full rounded-full border-none bg-white pe-10 ps-4 text-sm shadow-sm sm:w-56" id="search"
              type="search" placeholder="Pesquisar website..." />
        ...
        <a v-if="isLogged" href="#" class="block shrink-0">
      ...
      <div v-if="isLogged" class="mt-8">
        <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl">
          Bem vindo de volta, Jorge!
        </h1>

        <p class="mt-1.5 text-sm text-gray-500">
          O sistema teve um acréscimo de 52% em dados desde o último mês. Pra cima! 🚀
        </p>
      </div>
    </div>
  </header>
